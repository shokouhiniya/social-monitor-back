...
export const ERROR_CODES = {
  ...
  // --- micromedia-transformation (design §7) ---
  MICRO_MEDIA_NOT_FOUND: 'MICRO_MEDIA_NOT_FOUND',
  HUB_NOT_FOUND: 'HUB_NOT_FOUND',
  ACCESS_DENIED_TO_HUB: 'ACCESS_DENIED_TO_HUB',
  MEDIA_SCORE_INDICATOR_NOT_FOUND: 'MEDIA_SCORE_INDICATOR_NOT_FOUND',
...
export const ERROR_CODE_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  MICRO_MEDIA_NOT_FOUND: HttpStatus.NOT_FOUND,
  HUB_NOT_FOUND: HttpStatus.NOT_FOUND,
  ACCESS_DENIED_TO_HUB: HttpStatus.FORBIDDEN,
  MEDIA_SCORE_INDICATOR_NOT_FOUND: HttpStatus.NOT_FOUND,
  TASK_NOT_FOUND: HttpStatus.NOT_FOUND,
  OPERATION_NOT_FOUND: HttpStatus.NOT_FOUND,
  INVALID_TASK_SCOPE: HttpStatus.BAD_REQUEST,
  INVALID_SCORE_VALUE: HttpStatus.BAD_REQUEST,
